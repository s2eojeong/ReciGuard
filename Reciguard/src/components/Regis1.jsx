    ...
    return (
        ...
        <div className="regis-container">
            <div className="regis-header">레시피 소개</div>
                ...
                <label htmlFor="recipe-title" className="regis-label">레시피명</label>
            <input
                type="text"
                id="recipe-title"
            ...
            <div className="regis-group">
            <label htmlFor="category" className="regis-label">카테고리</label>
            <select id="category" className="regis-select">
                <option value="" disabled selected>국가별</option>
            ...
            <div className="regis-info">
                ...
                <option value="1">15분이내</option>
                <option value="1">30분이내</option>
                <option value="1">45분이내</option>
                <option value="1">60분이내</option>
                <option value="1">90분이내</option>
                <option value="1">2시간이내</option>
                <option value="1">2시간이상</option>
                </select>
            </div>
            </div>
        </div>
