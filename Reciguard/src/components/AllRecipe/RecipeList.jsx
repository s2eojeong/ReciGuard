  ...
  const handleScrap = async () => {
    ...
    try {
      const response = await fetch(
        `https://reciguard.comhttps://reciguard.com/recipes/scrap/${recipe.recipeId}`,
        {
          method: "POST",
          headers: {
...
const RecipeList = () => {
  ...
  const fetchRecipes = async () => {
    ...
    try {
      ...
      let url =
        selectedCuisine === "전체"
          ? `https://reciguard.comhttps://reciguard.com/recipes/all?filter=${filterEnabled}`
          : `https://reciguard.comhttps://reciguard.com/recipes?cuisine=${selectedCuisine}&filter=${filterEnabled}`;
